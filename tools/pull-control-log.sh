...
BUNDLE="com.openpocketview.app"
DEST="${DEST:-/tmp/opv-control-live.log}"
SOURCE="Documents/control-live.log"
...
then
    ...
    echo "Xcode console (com.openpocketview.app / session) is the live path until the file exists." >&2
    exit 1
fi
